...
# Upload data
supermarket_data <- read_csv("supermarket_store_sales.csv")
```
...
![Gross Income by Branch bar chart created on Tableau](/cloud/project/Gross income by branch.png)
...
![Product Line Breakdown by Gross Income and Gender created on Tableau](/cloud/project/Gross Income by Product Line and Gender.png)


![Gross Profit by Product Line pie chart created on tableau](/cloud/project/Gross Income by Product Line.png)
...
![Payment Type and Customer Type chart created on Tableau](/cloud/project/Payment Type between customer type.png)
